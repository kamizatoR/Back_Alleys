...
ActiveRecord::Schema.define(version: 2023_01_26_184816) do
  ...
  create_table "follow_followers", force: :cascade do |t|
    ...
    t.index ["followed_id"], name: "index_follow_followers_on_followed_id"
  ...
  add_foreign_key "follow_followers", "end_users", column: "follower_id"
end
